...
def sr_task(self, input_path, output_dir, scale=4, tile_size=512, tile_pad=64, use_memmap=False, task_id=None):
    ...
    result_path = run_super_resolution(input_path, output_dir, scale=scale, tile_size=tile_size, tile_pad=tile_pad, use_memmap=use_memmap, task_id=task_id)
    return result_path